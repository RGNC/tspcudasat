...
void seq_printm2_b(Object* multiset, unsigned int number_membranes, unsigned int T, unsigned int N) {
...
void seq_printm1_b(Object* multiset) {
...
void seq_printcnf_b(Object* multiset,unsigned int T) {
...
unsigned int seq_division_b(unsigned int NumMemb,int N,int M,int T, Object* multiset2)
{
...
void seq_evolution_m2_b(unsigned int NumMemb,unsigned int T,short int N, Object* multiset2,int mult_a, int e)
{
...
void seq_evolution_m1_b(short int N,short int M,unsigned short T,Object* multiset1, int e)
{
	Object obj_actual;
	char variable;
	short int i;
...
void seq_intercambio_b (Object* multiset1, Object* multiset2,unsigned int membranas_actuales2,int T,int N,int M)
{
	Object obj_actual;
        char variable = '\0';
        int TM1 = 5;
...
void seq_generation_b (int N,int M,int T,Object* multiset1,Object* multiset2)
{
	...
	unsigned int e=1;
        ...
        while(e <= N)
	{
		membranas_actuales2 = seq_division_b(membrana_actual,N,M,T,multiset2);
                ...
                seq_evolution_m1_b(N,M,T,multiset1,e);
                //seq_printm1_b(multiset1);
                
		seq_evolution_m2_b(membrana_actual,T,N,multiset2,mult_a,e);
                mult_a = mult_a -1;
        ...
        seq_intercambio_b(multiset1,multiset2,membranas_actuales2,T,N,M);
...
void seq_synchronization_b(Object* multiset2,Object* multiset1, unsigned int NumMemb,int N,int M, int T)
{
	Object obj_actual;
	char variable;
        int memb;
...
void ordenacion_seleccion_b(unsigned int NumMemb, unsigned short N, unsigned short M, unsigned short T, Object* multiset2)
{
    Object obj_actual;
    Object obj_aux;
    char variable;
...
void seq_checking_step_b(unsigned int NumMemb, unsigned short N, unsigned short M, unsigned short T, Object* multiset2)
{
        ...
        for(memb=0;memb<NumMemb;memb++)
	{
        ...
        ordenacion_seleccion_b(NumMemb,N,M,T, multiset2);
        //seq_printm2_b(multiset2,NumMemb,T,N);
...
bool seq_checkout_step_b(long int NumMemb,short int N,short int M,short int T, Object* multiset2)
{
    Object obj_actual;
    Object obj_d;
    int pos = 2*N +3 +1;
...
Object* seq_inicializa_multiset1_b(Object* multiset1)
{
...
Object* seq_inicializa_multiset2_b(Object* multiset2, int TM2, short int N,Object* cnf, short int T)
{
...
bool Sequential_solver_b(int N, int M, int T, Object * cnf) {
	...
	Object* multiset2 = new Object[TM2*NumMemb];
        ...
        multiset1 = seq_inicializa_multiset1_b(multiset1);
        multiset2 = seq_inicializa_multiset2_b(multiset2,TM2,N,cnf,T);
        ...
        seq_printcnf_b(cnf,T);
        
        // Imprime las membranas con la que estamos trabajando inicialmente 
        seq_printm1_b(multiset1);
        seq_printm2_b(multiset2,1,T,N);
	

	gettimeofday(&tini, NULL);
	
        
	seq_generation_b(N,M,T,multiset1,multiset2);
	...
	seq_synchronization_b(multiset2,multiset1,NumMemb,N,M,T);
        ...
        seq_checking_step_b(NumMemb,N,M,T,multiset2);
	...
	solution = seq_checkout_step_b(NumMemb,N,M,T,multiset2);
